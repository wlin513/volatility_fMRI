...
dest_dir<-"/home/wlin/Documents/2018_fMRI/behavior/behavior/data/rstan/RL_nonhierarchical_bias_model_onefit"
stan_dir<-"/home/wlin/Documents/2018_fMRI/behavior/behavior/code/rstan/RL_nonhierarchical_bias_model_onefit"
fig_dir<-"/home/wlin/Documents/2018_fMRI/behavior/behavior/tmp_fig/rstan/RL_nonhierarchical_bias_model_onefit"
...
source(file.path(stan_dir,"read_ests_bias_model_allblocks.R"))
...
#fit_prescan <- stan(file = file.path(stan_dir,'RL_nonhierarchical_bias_model_onefit.stan'), data = stan_data, iter = 4000, chains = 4, control=list(adapt_delta=0.999, max_treedepth = 10))
#save(fit_prescan,file=file.path(dest_dir,"RL_nonhierarchical_bias_model_onefit_prescan.RData"))
#library("shinystan")
...
fit_scandata <- stan(file = file.path(stan_dir,'RL_nonhierarchical_bias_model_onefit.stan'), data = stan_data, iter = 4000, chains = 4, control=list(adapt_delta=0.999, max_treedepth = 10))
save(fit_scandata,file=file.path(dest_dir,"RL_nonhierarchical_bias_model_onefit.RData"))
library("shinystan")
...
load(file=file.path(dest_dir,"RL_nonhierarchical_bias_model_onefit.RData"))
...
PN_bias_tr=subset(alldata,alldata$variables=="PN_bias_tr")
WL_bias_tr=subset(alldata,alldata$variables=="WL_bias_tr")
VS_bias_tr=subset(alldata,alldata$variables=="VS_bias_tr")
invx_tr=subset(alldata,alldata$variables=="invx_tr")
...
ggsave("alphas_RL_nonhierarchical_bias_model_onefit.eps", plot = palpha, device = "eps", path = fig_dir,
...
ggsave("betas_RL_nonhierarchical_bias_model_onefit.eps", plot = pbeta, device = "eps", path = fig_dir,
       scale = 1, width = 20, height = 10, units = "cm",
       dpi = 300, limitsize = TRUE)
...
library(R.matlab)
writeMat(file.path(dest_dir,'Result_bias_model.mat'),winposalphas=winposalphas,winnegalphas=winnegalphas,lossposalphas=lossposalphas,lossnegalphas=lossnegalphas,PN_bias_tr=PN_bias_tr,WL_bias_tr=WL_bias_tr,VS_bias_tr=VS_bias_tr,invx_tr=invx_tr)
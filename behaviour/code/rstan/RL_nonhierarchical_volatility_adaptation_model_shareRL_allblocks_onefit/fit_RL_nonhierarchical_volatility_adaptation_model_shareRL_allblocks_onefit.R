...
dest_dir<-"/home/wlin/Documents/2018_fMRI/behavior/behavior/data/rstan/RL_nonhierarchical_volatility_adaptation_model_shareRL_allblocks_onefit"
stan_dir<-"/home/wlin/Documents/2018_fMRI/behavior/behavior/code/rstan/RL_nonhierarchical_volatility_adaptation_model_shareRL_allblocks_onefit"
fig_dir<-"/home/wlin/Documents/2018_fMRI/behavior/behavior/tmp_fig/rstan/RL_nonhierarchical_volatility_adaptation_model_shareRL_allblocks_onefit"
...
source(file.path(stan_dir,"read_ests_vol_adpt_model_shareRL_allblocks.R"))
...
fit_scandata <- stan(file = file.path(stan_dir,'RL_nonhierarchical_volatility_adaptation_model_shareRL_allblocks_onefit.stan'), data = stan_data, iter = 4000, chains = 4, control=list(adapt_delta=0.999, max_treedepth = 10))
save(fit_scandata,file=file.path(dest_dir,"RL_nonhierarchical_volatility_adaptation_model_shareRL_allblocks_onefit.RData"))
library("shinystan")
...
load(file=file.path(dest_dir,"RL_nonhierarchical_volatility_adaptation_model_shareRL_allblocks_onefit.RData"))
...
library(R.matlab)
writeMat(file.path(dest_dir,'Result_vol_adpt_model_shareRL.mat'),winalphas=winalphas,lossalphas=lossalphas,betas=betas,win_vol_adpt_tr=win_vol_adpt_tr,loss_vol_adpt_tr=loss_vol_adpt_tr)
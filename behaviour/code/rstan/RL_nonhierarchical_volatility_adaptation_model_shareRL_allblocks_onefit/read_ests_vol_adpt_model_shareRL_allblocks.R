...
read_ests<- function(fit,IDs,blocknames){
  ...
  win_vol_adpt_tr=sumdata[paste0("win_vol_adpt_tr[",c(1:nsubs),"]"),1]
  loss_vol_adpt_tr=sumdata[paste0("loss_vol_adpt_tr[",c(1:nsubs),"]"),1]

  allbias=rbind(beta,win_vol_adpt_tr,loss_vol_adpt_tr)

...
ntrigger=10        # number of trigger 5 to start the task
nblk=2        # number of blocks in total
trinumperblk=2 # number of trials in a block
...
filename = 'demo_fMRI_4trial_'+expInfo['Subject Num']
trfilename = 'TRdemo_fMRI_4trial_'+expInfo['Subject Num'] 
